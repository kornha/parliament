...
const findContextForTrainingText = function() {
  return `
    ...
    **Field Specifications:**
    ...
    -- RECOGNIZABILITY: use a person's name in the Headline ONLY if a general reader would recognize it (heads of state, national politicians, major celebrities, big brands). Unknown people get their ROLE in the Headline — the name goes in the SubHeadline. Eg., "Tribunal Rejects Sara Morrison's Belfast Claim" is wrong (nobody knows Sara Morrison); "Tribunal Rejects Volunteer's Claim Against Belfast Film Festival" is right, with "Sara Morrison, who..." named in the SubHeadline.
    -- NO storyline shorthand: never assume the reader follows an ongoing race, feud, or saga. Name the frame, not just the development: "El-Sayed Mocked Over Detroit Rally Crowd" fails; "Michigan Senate Candidate El-Sayed Mocked Over Detroit Rally Crowd" works.
    ...
    -- CONTEXT DEBT: the SubHeadline must pay off whatever the Headline could not explain — identify people by name AND role, name the race/dispute/event they belong to. TEST: after reading Headline + SubHeadline together, a stranger with zero background should fully understand what happened and who was involved. If they'd still ask "who is this?" or "what is this about?", rewrite.
