...
class AirBnB extends GemComponent {
  AirBnB({Vector2? position}) : super(position: position);

  @override
  GemAttributes settings = AirBnBSettings();
...
class AirBnBSettings extends GemAttributes {
  @override
  List<String> names = ["AirBnB"];
